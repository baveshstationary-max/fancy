...
st.markdown("""
    ...
    /* True Responsive Flexbox Product Card */
    .auto-card {
    ...
    /* Automatically stack elements vertically on mobile viewports */
                    ...
                    if filtered_df.empty:
                        ...
                        with st.container(height=520):
                            ...
                            for item_id, group in grouped_df:
                                ...
                                # Render each product card using robust auto-adjusting HTML wrapper
                                ...
                                with c1:
                                    if st.button("◀", key=f"prev_{item_id}", use_container_width=True):
                                        ...
                                        st.rerun()
                                with c2:
                                    st.markdown(f'<div class="card-img-box"><img src="{img_list[current_idx]}"></div>', unsafe_allow_html=True)
                                with c3:
                                ...
                                st.markdown(f'''
                                    <div class="card-details">
                                        <div style="font-size: 15px; font-weight: 700; color: var(--text-main);">{item_name}</div>
                                        <div style="color: var(--text-desc); font-size: 11px; margin-top: 2px; font-weight: 500;">{desc}</div>
                                    </div>
